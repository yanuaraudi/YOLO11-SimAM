...
class ResNet18Stage(nn.Module):
    """Expose a single ResNet18 stage for use as a YOLO backbone layer."""
    
    _shared_backbone = None  # class-level cache so all stages share one model
    ...
    def __init__(self, stage: int):
        ...
        if ResNet18Stage._shared_backbone is None:
            ...
            ResNet18Stage._shared_backbone = nn.ModuleList([
                nn.Sequential(base.conv1, base.bn1, base.relu, base.maxpool),  # stem
